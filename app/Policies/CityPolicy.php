...
class CityPolicy
{
    ...
    {
        if($user->hasPermissionTo('BulkDelete City'))
        {
            return true;
        }
        return false;
    ...
    {
        if($user->hasPermissionTo('Restore City'))
        {
            return true;
        }
        return false;
    ...
    {
        if($user->hasPermissionTo('BulkRestore City'))
        {
            return true;
        }
        return false;
    ...
    {
        if($user->hasPermissionTo('ForceDelete City'))
        {
            return true;
        }
        return false;
    ...
    {
        if($user->hasPermissionTo('BulkForceDelete City'))
        {
            return true;
        }
        return false;
